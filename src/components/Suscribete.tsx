...
export const Suscribete = () => {
  return (
    <article className="bg-dark-purple p-4 mx-6 rounded-3xl flex gap-4 text-soft-blue-green mb-6 items-center justify-center sm:mx-10 sm:p-8 lg:mx-30 lg:rounded-[64px]">
      <img className="w-[40%] max-w-[250px] object-contain" src="images/ui/banners/banner_suscribete.png" alt="Carta con logo" />
